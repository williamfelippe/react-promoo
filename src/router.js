...
/*import EditAvatar from './containers/edit_avatar/edit_avatar';
import EditEmail from './containers/edit_email/edit_email';
import EditPassword from './containers/edit_password/edit_password';*/
    ...
    <Router history={browserHistory}>
        <Route component={MainLayout}>
            ...
            <Route path="dashboard">
                ...
                /*
                 // Usuário tem um layout específico
